    ...
    Swal.fire("Say the truth yeah!").then(function () {
      Swal.fire("Dont be lying okay!!", "", "error").then(function () {
        ...
        const {
          ...
          title: 'put your name first pleasee',
          input: 'text',
          inputLabel: '',
          showCancelButton: false,
          inputValidator: (value) => {
            if (!value) {
              return 'Fill the question baby'
            } else {
              nama = value;
            }
          }
          ...
          const pertanyaan = Swal.fire({
            title: `${nama} Like ${sender}'s program?`,
            showDenyButton: true,
            showCancelButton: false,
            ...
            if (result.isConfirmed) {
              ...
              Swal.fire(`Really you not like that ${sender}?`, '', 'error').then(function () {
                Swal.fire('Okay bye!')
              })
            }
          })
